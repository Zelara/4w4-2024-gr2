  ...
  <section class="section__cours">
    ...
    foreach ($categories as $category) : ?>
      <div class="contenu clr-agencement-rouge2">
        ...
        <p class="contenu-article"><?php echo sprintf(_n('<span class="article-nombre">%d</span> Article', '<span class="article-nombre">%d</span> Articles', $category->count), $category->count); ?></p>
